...
@Module
class PeopleModule(private val context: Context) {
    ...
    @Provides
    fun provideProfileFactory(actor: PeopleActor): PeopleStoreFactory {
        return PeopleStoreFactory(
            actor
        )
    }
